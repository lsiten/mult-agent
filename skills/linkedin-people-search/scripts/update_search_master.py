...
def main():
    parser = argparse.ArgumentParser(description="Update LinkedIn search-master.json with one candidate bundle.")
    parser.add_argument("--master-file", required=True, help="search-master.json path")
    parser.add_argument("--resume-file", required=True, help="candidate profile JSON path")
