...
- Subscriptions persist to `$HERMES_HOME/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `$HERMES_HOME/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook $HERMES_HOME/logs/gateway.log | tail -20`
