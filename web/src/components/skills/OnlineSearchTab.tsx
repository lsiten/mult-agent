...
/**
 * SkillCardContent - Shows skill info with installation status and error details
 */
      ...
      <div className="flex-1 min-w-0">
        ...
        {task && task.status === 'failed' && task.error_message && (
          <div className="mb-2 p-2 bg-destructive/10 border border-destructive/20 rounded">
            ...
            {task.error_details && (task.error_details as any).can_force_install && (
              <p className="text-[10px] text-muted-foreground mt-1">
                {t.skills.install.forceInstall || 'Use --force flag to override security scan'}
              </p>
            )}
          </div>
        )}
