    ...
    <div className="flex flex-col gap-6">
      ...
      {data && (
        <>
          ...
          {/* Tables */}
          {data.daily && data.daily.length > 0 && <DailyTable daily={data.daily} />}
          {data.by_model && data.by_model.length > 0 && <ModelTable models={data.by_model} />}
        </>
      )}

      {data && (!data.daily || data.daily.length === 0) && (!data.by_model || data.by_model.length === 0) && (
        <Card>
