...
Skins are defined as YAML files in $HERMES_HOME/skins/ or as built-in presets.
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from $HERMES_HOME/skins/
...
Drop a YAML file in ``$HERMES_HOME/skins/<name>.yaml`` following the schema above.
