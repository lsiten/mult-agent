...
import { ActivityCard, EventCard } from '../../src/components/cards'
import { EmptyState, Logo, MotionOverlay, StatusDot } from '../../src/components/misc'
...
import { useMCPAgent } from '../../src/agent/useMCPAgent'
...
export default function App() {
  ...
  const { status, history, activity, currentTask, config, execute, stop, configure } = useMCPAgent()
    ...
    <div className="relative flex flex-col h-screen bg-background">
      ...
      <header className="flex items-center justify-between border-b px-3 py-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium">Page Agent (MCP)</span>
        </div>
