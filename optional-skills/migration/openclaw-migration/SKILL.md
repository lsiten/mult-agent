...
- copy OpenClaw skills into `$HERMES_HOME/skills/openclaw-imports/`
...
- `$HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py`

Do not guess a shorter path like `$HERMES_HOME/skills/openclaw-migration/...`.

Before running the helper:

1. Prefer the installed path under `$HERMES_HOME/skills/migration/openclaw-migration/`.
...
```bash
python3 $HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py
```
...
```bash
python3 $HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --preset user-data
```

Execute a user-data migration:

```bash
python3 $HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset user-data --skill-conflict skip
```

Execute a full compatible migration:

```bash
python3 $HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset full --migrate-secrets --skill-conflict skip
```

Execute with workspace instructions included:

```bash
python3 $HERMES_HOME/skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py --execute --preset user-data --skill-conflict rename --workspace-target "/absolute/workspace/path"
```
...
- OpenClaw skills available under `$HERMES_HOME/skills/openclaw-imports/`
