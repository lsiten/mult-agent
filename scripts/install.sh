...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  --hermes-home PATH  Data directory (default: $HERMES_HOME, or \$HERMES_HOME)"
...
print_success() {
    ...
    # Show file locations
    echo -e "${CYAN}${BOLD}📁 Your files (all in $HERMES_HOME/):${NC}"
    echo ""
    ...
    echo -e "   ${YELLOW}Code:${NC}      $HERMES_HOME/hermes-agent/"
    echo ""
