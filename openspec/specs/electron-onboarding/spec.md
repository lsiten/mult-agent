...
Provide a guided first-run onboarding wizard for the Electron desktop application that helps users configure LLM providers, language preferences, and optional features (vision/image generation, browser automation, web search) through a multi-step modal interface.
