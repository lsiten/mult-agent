...
Enable users to connect Hermes browser automation to a local Chrome instance via Chrome DevTools Protocol (CDP) WebSocket connection, providing an alternative to bundled Chromium and cloud browser options.
